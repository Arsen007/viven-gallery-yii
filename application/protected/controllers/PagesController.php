...
class PagesController extends Controller
{
	 ...
	 */
	public $layout='webroot.themes.bootstrap.views.layouts.column2';
	 ...
	 */
	public function loadModel($page_url_name)
	{
		$model=Pages::model()->findByAttributes(array('url_name'=>$page_url_name));
