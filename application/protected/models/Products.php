...
class Products extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('custom_attributes, description, images, keywords', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, name, category_id, price, custom_attributes, description, image, images, url_name, state, visible, keywords', 'safe', 'on'=>'search'),
		);
	}
